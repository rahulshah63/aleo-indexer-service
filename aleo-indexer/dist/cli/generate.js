...
const aleoPrimitiveToDrizzlePg = {
 ...
 */
function getDrizzleType(typeConfig, name) {
 ...
 */
function getGraphQLType(typeConfig) {
    if (typeConfig.kind === 'primitive') {
 ...
 */
export async function generateSchemas(config) {
 ...
 * @param config The IndexerConfig.
 */
async function generateDrizzleSchema(config) {
    let schemaContent = `
